package com.example.crazytasktracker.security.jwt;
...
public class JwtUtils {
    ...
    public String generateJwtToken(ApplicationUserDetails userDetails){
    ...
    public Boolean validate(String authToken){
        try {
           ...
           log.error("Bad signature of token:{}", e.getMessage());
        }
